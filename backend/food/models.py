...
class User(AbstractUser):
    ...
    first_name = models.CharField(
        max_length=150, null=True, verbose_name="Имя", help_text="Укажите имя"
    )
...
class Tag(models.Model):
    name = models.CharField(
        max_length=200, verbose_name="Название", help_text="Укажите название"
    )
    color = models.CharField(
        max_length=7, verbose_name="Цвет", help_text="Укажите цвет"
    )
    slug = models.SlugField(
        unique=True, verbose_name="Slug", help_text="Укажите Slug"
    )
    ...
    cooking_time = models.PositiveSmallIntegerField(
        validators=(
            MinValueValidator(
                MIN_TIME,
                message=(
                    f"Время приготовления должно быть не менее {MIN_TIME}"
                ),
            ),
        ),
    ...
    amount = models.IntegerField(
        validators=(
            MinValueValidator(
                MIN_AMOUNT,
                message=(
                    f"Минимальное кол-во должно быть не меньше {MIN_AMOUNT}!"
                ),
            ),
        ),
        verbose_name="Кол-во",
